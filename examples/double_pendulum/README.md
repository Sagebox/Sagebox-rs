...
|--|--|
| `double_pendulum_simple` |  Displays the pendulum with a motion trail and outputs timing information to the Sagebox debug window. |
| `double_pendulum_interactive` | Introduces a handle_events() function, allowing the user to drag and reposition the pendulums during simulation. |
